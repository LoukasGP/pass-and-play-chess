...
jest.mock('@/components/GoogleAd', () => {
  return function GoogleAd({ slot }: { slot: string }) {
    return (
      <div data-testid={`google-ad-${slot}`}>
...
jest.mock('react-chessboard', () => ({
  Chessboard: ({ options }: { options: { position: string; onPieceDrop: (args: { sourceSquare: string; targetSquare: string | null }) => boolean } }) => (
    <div data-testid="chessboard" data-position={options.position}>
      <div data-testid="piece-drop-handler" onClick={() => {
...
describe('Chess Board Page', () => {
  ...
  describe('Rendering', () => {
    ...
    it('displays only chessboard - no visible headers or navigation', () => {
      ...
      const seoSection = document.querySelector('section[aria-label="About Pass & Play Chess"]')
  ...
  describe('SEO Content', () => {
    it('sr-only section contains expected keywords for search engines', () => {
      ...
      expect(seoSection).toBeInTheDocument()
      expect(seoSection).toHaveAttribute('aria-label', 'About Pass & Play Chess')
  ...
  describe('Ad Layout', () => {
    ...
    it('board remains centered between ad wrappers', () => {
      ...
      expect(leftWrapper.querySelector('[data-testid="google-ad-left-sidebar"]')).toBeInTheDocument()
      expect(rightWrapper.querySelector('[data-testid="google-ad-right-sidebar"]')).toBeInTheDocument()
      
      // Middle child should be the board container
      expect(boardContainer.querySelector('[data-testid="chessboard"]')).toBeInTheDocument()
    })
  })
})
