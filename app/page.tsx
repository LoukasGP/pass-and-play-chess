  ...
  return (
    <>
      <section className="sr-only" aria-label="About Pass & Play Chess">
        ...
        <p>
          Play chess offline with a friend on the same device. Our pass and play chess board 
          lets two players enjoy chess together without any account, login, or internet connection. 
          Perfect for playing chess on planes, trains, or anywhere offline.
        </p>
        <h2>Simple Two-Player Chess</h2>
        <p>
          Pass and play chess means two players share one device and take turns moving pieces. 
          Sit across from your opponent, make your move with drag and drop, then pass the device 
          to your friend. No complicated setup, no waiting for online opponents — just instant 
        ...
        <p>
          Unlike online chess platforms that require accounts and internet, our offline chess board 
          focuses on simplicity. Two players, one device, pure chess. Whether you&apos;re teaching 
          someone to play or enjoying a quick game, pass and play chess delivers the most 
          straightforward chess experience possible.
        </p>
      </section>
